...
#survival (pooled: s_Adult applied uniformly to all adult/immature stages)
s_Juv <- 0.78   # juvenile survival
s_Adult <- 0.92 # pooled adult survival
s_EF  <- s_Adult #experienced failed
s_ENB <- s_Adult #experienced non breeding
s_ES  <- s_Adult #experienced successful
s_IF  <- s_Adult #inexperienced failed
s_Imm <- s_Adult #immature
s_IS  <- s_Adult #inexperienced successful
s_PF  <- s_Adult #sabbatical
...
surv_params <- list(
  s_Juv   = calc_beta_params(0.780, 0.705, 0.850),  # juvenile survival — wide CI
  s_Adult = calc_beta_params(0.920, 0.880, 0.950)   # pooled adult survival — moderate CI
)
