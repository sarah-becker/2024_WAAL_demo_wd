----
title: "WAAL Bycatch — Period 2005-2009"
...
**load per-capita bycatch rates from 03f (2005–2009 period)**
```{r}
...
# Use 2005-2009 bycatch with 2005-2009 population (matching periods)
target_period_byc <- "2005-2009"
target_period_pop <- "2005-2009"
...
# Get 2005-2009 bycatch by fishery and calculate per-capita
