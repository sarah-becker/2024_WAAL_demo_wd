...
TO DO:
fine tune Bell et al. sceanrio vals from plot digitizer
fine tune Pardo et al. VR ranges from plot digitizer

6b-d then 7 using same assumptions
9 updates as well
4-9 into detailed methods doc
detailed methods doc into reasonable methods section/SI
analysis FINISHED and paper DRAFT by the end of the week (3/23)
Dissertation draft FINISHED by the end of the following week
...
byc_percap <- byc_period %>%
  ...
  select(fishery, fb, sb, nb, j1, j2j3, imm) %>%
...
**historical fleet mitigation — 1990-1994 baseline**
```{r hist-fleet-mitigation}
# 1990-1994: pre-CCAMLR mitigation era — all fleets at zero mitigation
