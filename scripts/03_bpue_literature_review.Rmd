...
# Also handle non-standard periods like "1995-2000" -> map to nearest target group(s)
expand_to_target_periods <- function(yg_string) {
  ...
  matched <- map(periods, function(p) {
    ...
    # Handle non-standard ranges by checking overlap with target periods
    # "1995-2000" spans both 1995-1999 and 2000-2004
    if (p == "1995-2000") return(c("1995-1999", "2000-2004"))
    # "2005-2010" maps to 2005-2009 (2010 is outside analysis period)
    if (p == "2005-2010") return("2005-2009")
    # leading-space variants
    if (p == " 1996-2000") return(c("1995-1999", "2000-2004"))
