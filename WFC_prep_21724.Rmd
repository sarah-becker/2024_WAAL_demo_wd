...
ggplot(fulldat_IUU)+
 ...
 # geom_line(data = output_l, aes(x=bycatch_reductions, y=lambda))+ #"best" VR
  geom_hline(aes(yintercept = 1), color = "red", alpha =0.5)+ 
  geom_line(aes(x=bycatch_reduction, y=mean_lambda, group = simrun), color = "blue")+ #mean VR
  labs(x="% fisheries with bycatch mitigation", y=" \u03BB")+
...
p1<- ggplot(fulldat_IUU_filtered)+
  geom_line(aes(x=bycatch_reduction, y=lambda, group = simrun), color = "grey", alpha = 0.1)+
 # geom_line(data = output_l, aes(x=bycatch_reductions, y=lambda))+ #"best" VR
  geom_hline(aes(yintercept = 1), color = "red", alpha =0.5)+ 
  geom_line(aes(x=bycatch_reduction, y=mean_lambda, group = simrun), color = "blue")+ #mean VR
...
ggsave(filename = "fulldat_IUU_p1",
         plot = p1, device = "png", width = 28, height = 7, units = "cm",
     path = here::here())
...
fulldat_IUU_prob1mit <- fulldat_IUU_filtered %>% 
  group_by(bycatch_reduction, mitigation_efficacy) %>% 
  summarise(prob1 =sum(lambda>=1)/length(lambda))
write_csv(fulldat_IUU_prob1mit, here::here("fulldat_IUU_prob1mit.csv"))

fulldat_IUU_meanlambda <- fulldat_IUU_filtered %>% 
  group_by(bycatch_reduction, mitigation_efficacy) %>% 
  summarise(mean_lambda =mean(lambda))
write_csv(fulldat_IUU_meanlambda, here::here("fulldat_IUU_meanlambda"))
```
...
ggsave(filename = "fulldat_IUU_prob1mit_line",
         plot = p2, device = "png", width = 14, height = 9, units = "cm",
     path = here::here())
```
...
# Heatmap 
p3<- ggplot(fulldat_IUU_prob1mit, aes(bycatch_reduction, mitigation_efficacy, fill= prob1)) + 
  geom_tile()+
  theme_bw()+
  coord_cartesian(expand=FALSE)+
...
ggsave(filename = "fulldat_IUU_prob1mit_heatmap_vir",
         plot = p3, device = "png", width = 14, height = 9, units = "cm",
     path = here::here())


grad <- c("#FF0000", "#CC0033", "#990066","#660099", "#3300CC", "#0000FF")

p3b<- ggplot(fulldat_IUU_prob1mit, aes(bycatch_reduction, mitigation_efficacy, fill= prob1)) + 
  geom_tile()+
  theme_bw()+
  coord_cartesian(expand=FALSE)+
  labs(x="% legal fisheries with bycatch mitigation", y="% mitigation efficacy", fill = "Probability \u03BB \u2265 1")+
  scale_fill_gradientn(colors  = grad, limits = c(0,1))

ggsave(filename = "fulldat_IUU_prob1mit_heatmap_rb",
         plot = p3b, device = "png", width = 14, height = 9, units = "cm",
     path = here::here())


p3c<- ggplot(fulldat_IUU_prob1mit, aes(bycatch_reduction, mitigation_efficacy, fill= prob1)) + 
  geom_tile()+
  theme_bw()+
  coord_cartesian(expand=FALSE)+
  labs(x="% legal fisheries with bycatch mitigation", y="% mitigation efficacy", fill = "Probability \u03BB \u2265 1")+
   scale_fill_distiller(direction =1, palette = "RdBu", limits =c(0,1))

ggsave(filename = "fulldat_IUU_prob1mit_heatmap_rb2",
         plot = p3c, device = "png", width = 14, height = 9, units = "cm",
     path = here::here())
...
```{r}
# Heatmap 
p4<- ggplot(fulldat_IUU_meanlambda, aes(bycatch_reduction, mitigation_efficacy, fill= mean_lambda)) + 
  geom_tile()+
  theme_bw()+
  coord_cartesian(expand=FALSE)+
  labs(x="% legal fisheries with bycatch mitigation", y="% mitigation efficacy", fill = "Mean \u03BB")+
  scale_fill_viridis_c(limits = c(0.9944091 , 1.0035894))
  #scale_fill_distiller(palette = "RdBu")


ggsave(filename = "fulldat_IUU_meanlamda_heatmap_vir",
         plot = p4, device = "png", width = 14, height = 9, units = "cm",
     path = here::here())


p4b<- ggplot(fulldat_IUU_meanlambda, aes(bycatch_reduction, mitigation_efficacy, fill= mean_lambda)) + 
  geom_tile()+
  theme_bw()+
  coord_cartesian(expand=FALSE)+
  labs(x="% legal fisheries with bycatch mitigation", y="% mitigation efficacy", fill = "Mean \u03BB")+
 scale_fill_gradientn(colors  = grad, limits = c(0.9944091 , 1.0035894))
  #scale_fill_distiller(palette = "RdBu")


ggsave(filename = "fulldat_IUU_meanlamda_heatmap_rb",
         plot = p4b, device = "png", width = 14, height = 9, units = "cm",
     path = here::here())

p4c<- ggplot(fulldat_IUU_meanlambda, aes(bycatch_reduction, mitigation_efficacy, fill= mean_lambda)) + 
  geom_tile()+
  theme_bw()+
  coord_cartesian(expand=FALSE)+
  labs(x="% legal fisheries with bycatch mitigation", y="% mitigation efficacy", fill = "Mean \u03BB")+
 #scale_fill_gradientn(colors  = grad, limits = grad_lims)
   scale_fill_distiller(direction =1, palette = "RdBu", limits = c(0.9944091 , 1.0035894))


ggsave(filename = "fulldat_IUU_meanlamda_heatmap_rb2",
         plot = p4c, device = "png", width = 14, height = 9, units = "cm",
     path = here::here())
```
...
p5<- ggplot(fulldat_IUU_meanlambda, aes(bycatch_reduction, mitigation_efficacy, fill= mean_lambda20)) + 
  geom_tile()+
  theme_bw()+
  coord_cartesian(expand=FALSE)+
  labs(x="% legal fisheries with bycatch mitigation", y="% mitigation efficacy", fill = "Mean \u03BB ^20")+
  scale_fill_viridis_c(limits = c(0.8939271, 1.0742888))
  #scale_fill_distiller(palette = "RdBu")

ggsave(filename = "fulldat_IUU_meanlamda20_heatmap_vir",
         plot = p5, device = "png", width = 14, height = 9, units = "cm",
     path = here::here())


p5b<- ggplot(fulldat_IUU_meanlambda, aes(bycatch_reduction, mitigation_efficacy, fill= mean_lambda20)) + 
  geom_tile()+
  theme_bw()+
  coord_cartesian(expand=FALSE)+
  labs(x="% legal fisheries with bycatch mitigation", y="% mitigation efficacy", fill = "Mean \u03BB ^20")+
   scale_fill_gradientn(colors  = grad, limits = c(0.8939271, 1.0742888))
  #scale_fill_distiller(palette = "RdBu")

ggsave(filename = "fulldat_IUU_meanlamda20_heatmap_rb",
         plot = p5b, device = "png", width = 14, height = 9, units = "cm",
     path = here::here())

p5c<- ggplot(fulldat_IUU_meanlambda, aes(bycatch_reduction, mitigation_efficacy, fill= mean_lambda20)) + 
  geom_tile()+
  theme_bw()+
  coord_cartesian(expand=FALSE)+
  labs(x="% legal fisheries with bycatch mitigation", y="% mitigation efficacy", fill = "Mean \u03BB ^20")+
   #scale_fill_gradientn(colors  = grad, limits = grad_lims)
  scale_fill_distiller(direction = 1, palette = "RdBu", limits = c(0.8939271, 1.0742888))

ggsave(filename = "fulldat_IUU_meanlamda20_heatmap_rb2",
         plot = p5c, device = "png", width = 14, height = 9, units = "cm",
     path = here::here())
```
...
p6<- ggplot(fulldat_IUU_none_filtered)+
  geom_line(aes(x=bycatch_reduction, y=lambda, group = simrun), color = "grey", alpha = 0.1)+
 # geom_line(data = output_l, aes(x=bycatch_reductions, y=lambda))+ #"best" VR
  geom_hline(aes(yintercept = 1), color = "red", alpha =0.5)+ 
  geom_line(aes(x=bycatch_reduction, y=mean_lambda, group = simrun), color = "blue")+ #mean VR
...
ggsave(filename = "fulldat_IUU_none_prob1",
         plot = p6, device = "png", width = 28, height = 7, units = "cm",
     path = here::here())
...
fulldat_IUU_none_prob1mit <- fulldat_IUU_none_filtered %>% 
  group_by(bycatch_reduction, mitigation_efficacy) %>% 
  summarise(prob1 =sum(lambda>=1)/length(lambda))
write_csv(fulldat_IUU_none_prob1mit, here::here("fulldat_IUU_none_prob1mit"))

fulldat_IUU_none_meanlambda <- fulldat_IUU_none_filtered %>% 
  group_by(bycatch_reduction, mitigation_efficacy) %>% 
  summarise(mean_lambda =mean(lambda))
write_csv(fulldat_IUU_none_meanlambda, here::here("fulldat_IUU_none_meanlambda"))
```
...
ggsave(filename = "fulldat_IUU_none_prob1_line",
         plot = p7, device = "png", width = 14, height = 9, units = "cm",
     path = here::here())
```

*heatmap prob1*
```{r}
p8<- ggplot(fulldat_IUU_none_prob1mit, aes(bycatch_reduction, mitigation_efficacy, fill= prob1)) + 
  geom_tile()+
  theme_bw()+
  coord_cartesian(expand=FALSE)+
  labs(x="% legal fisheries with bycatch mitigation", y="% mitigation efficacy", fill = "Probability \u03BB \u2265 1")+
...
ggsave(filename = "fulldat_IUU_none_prob1_heatmap_vir",
         plot = p8, device = "png", width = 14, height = 9, units = "cm",
     path = here::here())


p8b<- ggplot(fulldat_IUU_none_prob1mit, aes(bycatch_reduction, mitigation_efficacy, fill= prob1)) + 
  geom_tile()+
  theme_bw()+
  coord_cartesian(expand=FALSE)+
  labs(x="% legal fisheries with bycatch mitigation", y="% mitigation efficacy", fill = "Probability \u03BB \u2265 1")+
...
ggsave(filename = "fulldat_IUU_none_prob1_heatmap_rb",
         plot = p8b, device = "png", width = 14, height = 9, units = "cm",
     path = here::here())




p8c<- ggplot(fulldat_IUU_none_prob1mit, aes(bycatch_reduction, mitigation_efficacy, fill= prob1)) + 
  geom_tile()+
  theme_bw()+
  coord_cartesian(expand=FALSE)+
  labs(x="% legal fisheries with bycatch mitigation", y="% mitigation efficacy", fill = "Probability \u03BB \u2265 1")+
...
ggsave(filename = "fulldat_IUU_none_prob1_heatmap_rb2",
         plot = p8c, device = "png", width = 14, height = 9, units = "cm",
     path = here::here())
...
```{r}
# Heatmap 
p9<- ggplot(fulldat_IUU_none_meanlambda, aes(bycatch_reduction, mitigation_efficacy, fill= mean_lambda)) + 
  geom_tile()+
  theme_bw()+
  coord_cartesian(expand=FALSE)+
  labs(x="% legal fisheries with bycatch mitigation", y="% mitigation efficacy", fill = "Mean \u03BB")+
...
ggsave(filename = "fulldat_IUU_none_meanlamda_heatmap_vir",
         plot = p9, device = "png", width = 14, height = 9, units = "cm",
     path = here::here())


p9b<- ggplot(fulldat_IUU_none_meanlambda, aes(bycatch_reduction, mitigation_efficacy, fill= mean_lambda)) + 
  geom_tile()+
  theme_bw()+
  coord_cartesian(expand=FALSE)+
  labs(x="% legal fisheries with bycatch mitigation", y="% mitigation efficacy", fill = "Mean \u03BB")+
...
ggsave(filename = "fulldat_IUU_none_meanlamda_heatmap_rb",
         plot = p9b, device = "png", width = 14, height = 9, units = "cm",
     path = here::here())


p9c<- ggplot(fulldat_IUU_none_meanlambda, aes(bycatch_reduction, mitigation_efficacy, fill= mean_lambda)) + 
  geom_tile()+
  theme_bw()+
  coord_cartesian(expand=FALSE)+
  labs(x="% legal fisheries with bycatch mitigation", y="% mitigation efficacy", fill = "Mean \u03BB")+
...
ggsave(filename = "fulldat_IUU_none_meanlamda_heatmap_rb2",
         plot = p9c, device = "png", width = 14, height = 9, units = "cm",
     path = here::here())
```
...
fulldat_IUU_high_prob1mit <- fulldat_IUU_high_filtered %>% 
  group_by(bycatch_reduction, mitigation_efficacy) %>% 
  summarise(prob1 =sum(lambda>=1)/length(lambda))
write_csv(fulldat_IUU_high_prob1mit, here::here("fulldat_IUU_high_prob1mit"))

fulldat_IUU_high_meanlambda <- fulldat_IUU_high_filtered %>% 
  group_by(bycatch_reduction, mitigation_efficacy) %>% 
  summarise(mean_lambda =mean(lambda))
write_csv(fulldat_IUU_high_meanlambda, here::here("fulldat_IUU_high_meanlambda"))
```
...
```{r}
# Heatmap 
p10<- ggplot(fulldat_IUU_high_prob1mit, aes(bycatch_reduction, mitigation_efficacy, fill= prob1)) + 
  geom_tile()+
  theme_bw()+
  coord_cartesian(expand=FALSE)+
  labs(x="% legal fisheries with bycatch mitigation", y="% mitigation efficacy", fill = "Probability \u03BB \u2265 1")+
...
ggsave(filename = "fulldat_IUU_high_prob1_vir",
         plot = p10, device = "png", width = 14, height = 9, units = "cm",
     path = here::here())


p10b<- ggplot(fulldat_IUU_high_prob1mit, aes(bycatch_reduction, mitigation_efficacy, fill= prob1)) + 
  geom_tile()+
  theme_bw()+
  coord_cartesian(expand=FALSE)+
  labs(x="% legal fisheries with bycatch mitigation", y="% mitigation efficacy", fill = "Probability \u03BB \u2265 1")+
...
ggsave(filename = "fulldat_IUU_high_prob1_rb",
         plot = p10b, device = "png", width = 14, height = 9, units = "cm",
     path = here::here())


p10c<- ggplot(fulldat_IUU_high_prob1mit, aes(bycatch_reduction, mitigation_efficacy, fill= prob1)) + 
  geom_tile()+
  theme_bw()+
  coord_cartesian(expand=FALSE)+
  labs(x="% legal fisheries with bycatch mitigation", y="% mitigation efficacy", fill = "Probability \u03BB \u2265 1")+
...
ggsave(filename = "fulldat_IUU_high_prob1_rb2",
         plot = p10c, device = "png", width = 14, height = 9, units = "cm",
     path = here::here())
...
grandmin <- min(grad_lims)
grandmax <- max(grad_lims)

#define the number of breaks.  In this case 8 +1 
mybreaks <- seq(grandmin, grandmax, length.out = 15)
#Function to return the dersired number of colors
mycolors<- function(x) {
   colors<-colorRampPalette(c("darkblue", "yellow"))( 14 )
   colors[1:x]
}

#Function to create labels for legend
breaklabel <- function(x){
   labels<- paste0(mybreaks[1:8], "-", mybreaks[2:15])
   labels[1:x]
}
...
#geom_tile()+
ggplot(fulldat_IUU_high_meanlambda, aes(bycatch_reduction, mitigation_efficacy, z=mean_lambda)) + 
  geom_contour_filled(breaks = mybreaks, show.legend = TRUE)+
  theme_bw()+
  coord_cartesian(expand=FALSE)+
  labs(x="% legal fisheries with bycatch mitigation", y="% mitigation efficacy", fill = "Mean \u03BB")+
scale_fill_manual(palette=mycolors, values=breaklabel(14), name="Value", drop=FALSE)
  #scale_fill_viridis_c()
  #scale_fill_viridis_b()
  #scale_fill_distiller(palette = "RdBu")
#scale_fill_binned(guide = guide_bins(show.limits = T))
...
fulldat_IUU_med_prob1mit <- fulldat_IUU_med_filtered %>% 
  group_by(bycatch_reduction, mitigation_efficacy) %>% 
  summarise(prob1 =sum(lambda>=1)/length(lambda))
write_csv(fulldat_IUU_med_prob1mit, here::here("fulldat_IUU_med_prob1mit"))

fulldat_IUU_med_meanlambda <- fulldat_IUU_med_filtered %>% 
  group_by(bycatch_reduction, mitigation_efficacy) %>% 
  summarise(mean_lambda =mean(lambda))
write_csv(fulldat_IUU_med_meanlambda, here::here("fulldat_IUU_med_meanlambda"))
```
...
fulldat_IUU_low_prob1mit <- fulldat_IUU_low_filtered %>% 
  group_by(bycatch_reduction, mitigation_efficacy) %>% 
  summarise(prob1 =sum(lambda>=1)/length(lambda))
write_csv(fulldat_IUU_low_prob1mit, here::here("fulldat_IUU_low_prob1mit"))

fulldat_IUU_low_meanlambda <- fulldat_IUU_low_filtered %>% 
  group_by(bycatch_reduction, mitigation_efficacy) %>% 
  summarise(mean_lambda =mean(lambda))
write_csv(fulldat_IUU_low_meanlambda, here::here("fulldat_IUU_low_meanlambda"))
```
...
#grad <- c("#67001f", "#b2182b", "#d6604d", "#f4a582","#fddbc7","#f7f7f7", "#d1e5f0","#92c5de","#4393c3","#2166ac","#053061")

#grad <- c("#67001f", "#b2182b",  "#542788","#2166ac", "#4393c3")
#grad <- c("#67001f", "#b2182b", "#c51b7d",  "#542788","#2166ac", "#4393c3")
 #grad <- c("#67001f", "#c51b7d",  "#542788","#2166ac", "#4393c3")
#grad <- c( "#b2182b", "#c51b7d",  "#542788","#2166ac", "#4393c3")

#grad <- c("#1034A6", "#412f88",  "#722B6A","#A2264B", "#D3212D", "#F62D2D")
#grad <- c("#F62D2D", "#D3212D", "#A2264B","#722B6A", "#412f88", "#1034A6")

grad <- c("#FF0000", "#CC0033", "#990066","#660099", "#3300CC", "#0000FF")
grad_lims <- c(0 ,1)


noIUU1 <- ggplot(fulldat_IUU_none_prob1mit, aes(bycatch_reduction, mitigation_efficacy, fill= prob1)) + 
  geom_tile()+
  theme_bw()+
  coord_cartesian(expand=FALSE)+
  labs(x="% legal fisheries with bycatch mitigation", y="% mitigation efficacy", fill = "Probability \u03BB \u2265 1")+
 #scale_fill_viridis_c(limits = grad_lims)
 scale_fill_gradientn(colors  = grad, limits = grad_lims)
 #scale_fill_distiller(direction =1, palette = "RdBu", limits = grad_lims)



ggsave(filename = "fulldat_IUU_none_prob1_heatmap_rb",
         plot = noIUU1, device = "png", width = 14, height = 9, units = "cm",
     path = here::here())



noIUU1b <- ggplot(fulldat_IUU_none_prob1mit, aes(bycatch_reduction, mitigation_efficacy, fill= prob1)) + 
  geom_tile()+
  theme_bw()+
  coord_cartesian(expand=FALSE)+
  labs(x="% legal fisheries with bycatch mitigation", y="% mitigation efficacy", fill = "Probability \u03BB \u2265 1")+
...
ggsave(filename = "fulldat_IUU_none_prob1_heatmap_rb2",
         plot = noIUU1b, device = "png", width = 14, height = 9, units = "cm",
     path = here::here())



noIUU1c <- ggplot(fulldat_IUU_none_prob1mit, aes(bycatch_reduction, mitigation_efficacy, fill= prob1)) + 
  geom_tile()+
  theme_bw()+
  coord_cartesian(expand=FALSE)+
  labs(x="% legal fisheries with bycatch mitigation", y="% mitigation efficacy", fill = "Probability \u03BB \u2265 1")+
...
ggsave(filename = "fulldat_IUU_none_prob1_heatmap_vir",
         plot = noIUU1c, device = "png", width = 14, height = 9, units = "cm",
     path = here::here())
...
highIUU<- ggplot(fulldat_IUU_high_prob1mit, aes(bycatch_reduction, mitigation_efficacy, fill= prob1)) + 
  geom_tile()+
  theme_bw()+
  coord_cartesian(expand=FALSE)+
  labs(x="% legal fisheries with bycatch mitigation", y="% mitigation efficacy", fill = "Probability \u03BB \u2265 1")+
...
ggsave(filename = "fulldat_IUU_high_prob1_heatmap_rb",
         plot = highIUU, device = "png", width = 14, height = 9, units = "cm",
     path = here::here())


highIUUb<- ggplot(fulldat_IUU_high_prob1mit, aes(bycatch_reduction, mitigation_efficacy, fill= prob1)) + 
  geom_tile()+
  theme_bw()+
  coord_cartesian(expand=FALSE)+
  labs(x="% legal fisheries with bycatch mitigation", y="% mitigation efficacy", fill = "Probability \u03BB \u2265 1")+
...
ggsave(filename = "fulldat_IUU_high_prob1_heatmap_rb2",
         plot = highIUUb, device = "png", width = 14, height = 9, units = "cm",
     path = here::here())



highIUUc<- ggplot(fulldat_IUU_high_prob1mit, aes(bycatch_reduction, mitigation_efficacy, fill= prob1)) + 
  geom_tile()+
  theme_bw()+
  coord_cartesian(expand=FALSE)+
  labs(x="% legal fisheries with bycatch mitigation", y="% mitigation efficacy", fill = "Probability \u03BB \u2265 1")+
...
ggsave(filename = "fulldat_IUU_high_prob1_heatmap_vir",
         plot = highIUUc, device = "png", width = 14, height = 9, units = "cm",
     path = here::here())
...
medIUU <- ggplot(fulldat_IUU_med_prob1mit, aes(bycatch_reduction, mitigation_efficacy, fill= prob1)) + 
  geom_tile()+
  theme_bw()+
  coord_cartesian(expand=FALSE)+
  labs(x="% legal fisheries with bycatch mitigation", y="% mitigation efficacy", fill = "Probability \u03BB \u2265 1")+
...
ggsave(filename = "fulldat_IUU_med_prob1_heatmap_rb2",
         plot = medIUU, device = "png", width = 14, height = 9, units = "cm",
     path = here::here())
...
lowIUU<- ggplot(fulldat_IUU_low_prob1mit, aes(bycatch_reduction, mitigation_efficacy, fill= prob1)) + 
  geom_tile()+
  theme_bw()+
  coord_cartesian(expand=FALSE)+
  labs(x="% legal fisheries with bycatch mitigation", y="% mitigation efficacy", fill = "Probability \u03BB \u2265 1")+
...
ggsave(filename = "fulldat_IUU_low_prob1_heatmap_rb2",
         plot = lowIUU, device = "png", width = 14, height = 9, units = "cm",
     path = here::here())
```
...
grad <- c("#FF0000", "#CC0033", "#990066","#660099", "#3300CC", "#0000FF")
#grad_lims <- c(0 ,1)
grad_lims <-c(0.8939271, 1.0742888)


meanl20none <- ggplot(fulldat_IUU_none_meanlambda, aes(bycatch_reduction, mitigation_efficacy, fill= mean_lambda^20)) + 
  geom_tile()+
  theme_bw()+
  coord_cartesian(expand=FALSE)+
  labs(x="% legal fisheries with bycatch mitigation", y="% mitigation efficacy", fill = "Mean \u03BB ^20")+
...
ggsave(filename = "fulldat_IUU_none_meanlamda20_heatmap_rb2",
         plot = meanl20none, device = "png", width = 14, height = 9, units = "cm",
     path = here::here())
```

```{r}

meanl20high <- ggplot(fulldat_IUU_high_meanlambda, aes(bycatch_reduction, mitigation_efficacy, fill= mean_lambda^20)) + 
  geom_tile()+
  theme_bw()+
  coord_cartesian(expand=FALSE)+
  labs(x="% legal fisheries with bycatch mitigation", y="% mitigation efficacy", fill = "Mean \u03BB ^20")+
...
ggsave(filename = "fulldat_IUU_high_meanlamda20_heatmap_rb2",
         plot = meanl20high, device = "png", width = 14, height = 9, units = "cm",
     path = here::here())
```

```{r}

meanl20med <- ggplot(fulldat_IUU_med_meanlambda, aes(bycatch_reduction, mitigation_efficacy, fill= mean_lambda^20)) + 
  geom_tile()+
  theme_bw()+
  coord_cartesian(expand=FALSE)+
  labs(x="% legal fisheries with bycatch mitigation", y="% mitigation efficacy", fill = "Mean \u03BB ^20")+
...
ggsave(filename = "fulldat_IUU_med_meanlamda20_heatmap_rb2",
         plot = meanl20med, device = "png", width = 14, height = 9, units = "cm",
     path = here::here())
...
meanl20low<- ggplot(fulldat_IUU_low_meanlambda, aes(bycatch_reduction, mitigation_efficacy, fill= mean_lambda^20)) + 
  geom_tile()+
  theme_bw()+
  coord_cartesian(expand=FALSE)+
  labs(x="% legal fisheries with bycatch mitigation", y="% mitigation efficacy", fill = "Mean \u03BB ^20")+
...
ggsave(filename = "fulldat_IUU_low_meanlamda20_heatmap_rb2",
         plot = meanl20low, device = "png", width = 14, height = 9, units = "cm",
     path = here::here())
...
I think this one might be wrong - this may have been overwritten by the low IUU somehow
```{r}
# grad_lims2<- c(0.8 ,1.0742888)
# ggplot(fulldat_IUU_low_meanlambda, aes(bycatch_reduction, mitigation_efficacy, fill= mean_lambda^20)) + 
#   geom_tile()+
#   theme_bw()+
#   coord_cartesian(expand=FALSE)+
#   labs(x="% legal fisheries with bycatch mitigation", y="% mitigation efficacy", fill = "Mean \u03BB ^20")+
...
grad <- c("#FF0000", "#CC0033", "#990066","#660099", "#3300CC", "#0000FF")
#grad_lims <- c(0 ,1)
grad_lims <-c(0.9944091 , 1.0035894)


meanlnone <- ggplot(fulldat_IUU_none_meanlambda, aes(bycatch_reduction, mitigation_efficacy, fill= mean_lambda)) + 
  geom_tile()+
  theme_bw()+
  coord_cartesian(expand=FALSE)+
  labs(x="% legal fisheries with bycatch mitigation", y="% mitigation efficacy", fill = "Mean \u03BB ^20")+
...
ggsave(filename = "fulldat_IUU_none_meanlamda_heatmap_rb2",
         plot = meanlnone, device = "png", width = 14, height = 9, units = "cm",
     path = here::here())
```

```{r}

meanlhigh <- ggplot(fulldat_IUU_high_meanlambda, aes(bycatch_reduction, mitigation_efficacy, fill= mean_lambda)) + 
  geom_tile()+
  theme_bw()+
  coord_cartesian(expand=FALSE)+
  labs(x="% legal fisheries with bycatch mitigation", y="% mitigation efficacy", fill = "Mean \u03BB ^20")+
...
ggsave(filename = "fulldat_IUU_high_meanlamda_heatmap_rb2",
         plot = meanlhigh, device = "png", width = 14, height = 9, units = "cm",
     path = here::here())
```

```{r}

meanlmed <- ggplot(fulldat_IUU_med_meanlambda, aes(bycatch_reduction, mitigation_efficacy, fill= mean_lambda)) + 
  geom_tile()+
  theme_bw()+
  coord_cartesian(expand=FALSE)+
  labs(x="% legal fisheries with bycatch mitigation", y="% mitigation efficacy", fill = "Mean \u03BB ^20")+
...
ggsave(filename = "fulldat_IUU_med_meanlamda_heatmap_rb2",
         plot = meanlmed, device = "png", width = 14, height = 9, units = "cm",
     path = here::here())
...
meanllow<- ggplot(fulldat_IUU_low_meanlambda, aes(bycatch_reduction, mitigation_efficacy, fill= mean_lambda)) + 
  geom_tile()+
  theme_bw()+
  coord_cartesian(expand=FALSE)+
  labs(x="% legal fisheries with bycatch mitigation", y="% mitigation efficacy", fill = "Mean \u03BB ^20")+
...
ggsave(filename = "fulldat_IUU_low_meanlamda_heatmap_rb2",
         plot = meanllow, device = "png", width = 14, height = 9, units = "cm",
     path = here::here())
