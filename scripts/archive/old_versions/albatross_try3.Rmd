...
for(j in 1:length(sims)){
    ...
    s_c2 <- sample(seq(0.6,0.68, by =0.01), size =1, replace = TRUE) #chick+ fledgling survival year 0-1 - 0.64 
    s_j2 <- sample(seq(0.7,0.9, by = 0.01), size =1, replace = TRUE) #juvenile survival year 1-3 -  0.8 
    s_i2 <- sample(seq(0.89,0.95, by =0.01), size =1, replace = TRUE) #immature survival year 3-7 -  0.92
    ...
    bs_a2 <- sample(seq(0.7,0.9, by =0.01), size =1, replace = TRUE) #adult breeding success - 0.8 
    bp_a2 <- sample(seq(0.4,0.5, by =0.01), size=1, replace = TRUE)  #adult breeding probablity (biennial breeding, most breeding by age 10) - 0.45
    ...
    w2 <- sample(seq(0.25,0.5, by =0.01), size=1, replace = TRUE)
    w42 <- 1
