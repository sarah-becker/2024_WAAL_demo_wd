...
```{r}
# Load fleet-level bycatch for the baseline period (1990-1994)
...
# For baseline period (1990-1994), classify each fleet's BPUE source
...
fig_path <- function(name) here("output/figures", paste0(name, "_", date_sfx, ".png"))
