...
write_csv(validation, here("output/demographic_validation_03f.csv"))
write_csv(percap_period_combined, here("output/demographic_validation_by_period_03f.csv"))
write_csv(mortality_budget, here("output/mortality_budget_03f.csv"))
```
