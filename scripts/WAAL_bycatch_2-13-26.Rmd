...
ggplot(grid_opt1, aes(x = coverage, y = efficacy, fill = lambda)) +
  geom_tile() +
...
ggplot(grid_opt2, aes(x = coverage, y = efficacy, fill = lambda)) +
  geom_tile() +
  geom_contour(aes(z = lambda), breaks = 1, color = "white", linewidth = 0.8) +
...
ggplot(grid_opt3, aes(x = coverage, y = efficacy, fill = lambda)) +
  geom_tile() +
  geom_contour(aes(z = lambda), breaks = 1, color = "white", linewidth = 1) +
...
ggplot(grid_opt4a, aes(x = coverage, y = efficacy, fill = lambda)) +
  geom_tile() +
  geom_contour(aes(z = lambda), breaks = 1, color = "white", linewidth = 1) +
...
ggplot(iuu_grid_4b, aes(x = iuu_prop, y = iuu_reduction, fill = lambda)) +
  geom_tile() +
  geom_contour(aes(z = lambda), breaks = 1, color = "white", linewidth = 1) +
  scale_fill_distiller(direction = 1, palette = "RdBu") +
