...
# Historical mitigation status for 2000-2004 — growing CCAMLR adoption, some DLL fleets
# PLACEHOLDERS: CCAMLR at partial-to-full, Falklands improving; PLL still minimal
hist_fleet_mitigation <- tribble(
  ~fishery, ~fleet,                           ~status,    ~compliance,  ~notes,
  "DLL",    "CCAMLR",                         "partial",  0.60,         "strengthening compliance",
  "DLL",    "Argentina",                      "partial",  0.20,         "early adoption",
  "DLL",    "Chile",                          "none",     0.0,          "no mitigation",
  "DLL",    "Falklands",                      "partial",  0.50,         "improving adoption",
  "DLL",    "South Africa",                   "partial",  0.30,         "early measures",
  "DLL",    "New Zealand",                    "partial",  0.40,         "early ACAP-influenced measures",
