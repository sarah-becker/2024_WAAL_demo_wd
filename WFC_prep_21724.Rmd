...
ggplot(fulldat_IUU_none_meanlambda, aes(bycatch_reduction, mitigation_efficacy, fill= mean_lambda^20)) + 
  geom_tile()+
  theme_bw()+
  coord_cartesian(expand=FALSE)+
  labs(x="% legal fisheries with bycatch mitigation", y="% mitigation efficacy", fill = "Mean \u03BB ^20")+
...
ggplot(fulldat_IUU_high_meanlambda, aes(bycatch_reduction, mitigation_efficacy, fill= mean_lambda^20)) + 
  geom_tile()+
  theme_bw()+
  coord_cartesian(expand=FALSE)+
  labs(x="% legal fisheries with bycatch mitigation", y="% mitigation efficacy", fill = "Mean \u03BB ^20")+
...
ggplot(fulldat_IUU_med_meanlambda, aes(bycatch_reduction, mitigation_efficacy, fill= mean_lambda^20)) + 
  geom_tile()+
  theme_bw()+
  coord_cartesian(expand=FALSE)+
  labs(x="% legal fisheries with bycatch mitigation", y="% mitigation efficacy", fill = "Mean \u03BB ^20")+
