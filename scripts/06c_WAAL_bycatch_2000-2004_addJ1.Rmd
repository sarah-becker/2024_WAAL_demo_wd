---
title: "WAAL Bycatch — Period 2000–2004"
...
**load per-capita bycatch rates from 03f (2000–2004 period)**
```{r}
...
# Use 2000-2004 bycatch with 2000-2004 population (matching periods)
target_period_byc <- "2000-2004"
target_period_pop <- "2000-2004"
...
# Get 2000-2004 bycatch by fishery and calculate per-capita
...
ggsave(fig_path("28_iuu_12panel_mean"), p_iuu_12panel_mean, width = 16, height = 12, dpi = 200)
