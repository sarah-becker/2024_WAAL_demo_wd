---
title: "WAAL Bycatch — Period 1995–1999"
...
**load per-capita bycatch rates from 03f (1995–1999 period)**
```{r}
...
# Use 1995-1999 bycatch with 1995-1999 population (matching periods)
target_period_byc <- "1995-1999"
target_period_pop <- "1995-1999"
...
# Get 1995-1999 bycatch by fishery and calculate per-capita
