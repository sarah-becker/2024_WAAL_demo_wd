...
mitigation_scenarios <- tibble(
  scenario = c("Night setting only",
               "Line weighting only",
               "Tori lines only",
               "2/3 literature",
               "3/3 literature",
               "2/3 ACAP (Bell et al. 2025)",
               "3/3 ACAP (Bell et al. 2025)",
               "2/3 ICCAT (Bell et al. 2025)",
               "3/3 ICCAT (Bell et al. 2025)",
               "Complete elimination"),
  efficacy = c(eff_night_set,                                            # 0.60
               eff_line_weight,                                          # 0.65
               eff_tori_lines,                                           # 0.75
               eff_2of3,                                                 # tori + night combined
               eff_3of3,                                                 # all three combined
               bell_2of3_acap_20S,                                       # Bell et al. 2025 ACAP 2/3 mean
               bell_3of3_acap_20S,                                       # Bell et al. 2025 ACAP 3/3
               bell_2of3_iccat_20S,                                      # Bell et al. 2025 ICCAT 2/3 mean
               bell_3of3_iccat_20S,                                      # Bell et al. 2025 ICCAT 3/3
               1.0),                                                     # theoretical maximum
  source = c(rep("Literature", 5),
             rep("Bell ACAP", 2),
             rep("Bell ICCAT", 2),
             "Literature")
)
...
# Named color vector — 3 ramps by source group, ordered light-to-dark within each
# Literature (blues), Bell ACAP (greens), Bell ICCAT (oranges)
scenario_colors <- c(
  "Night setting only"           = "#9ecae1",
  "Line weighting only"          = "#6baed6",
  "Tori lines only"              = "#3182bd",
  "2/3 literature"               = "#08519c",
  "3/3 literature"               = "#08306b",
  "Complete elimination"         = "#030d1f",
  "2/3 ACAP (Bell et al. 2025)"  = "#74c476",
  "3/3 ACAP (Bell et al. 2025)"  = "#238b45",
  "2/3 ICCAT (Bell et al. 2025)" = "#fd8d3c",
  "3/3 ICCAT (Bell et al. 2025)" = "#d94701"
)
```
...
fleet_mitigation <- tribble(
  ...
  # --- DLL fleets ---
  # CCAMLR row removed: fleet_byc uses country names, not "CCAMLR" — some individual countries below carry CCAMLR status
  "DLL",    "Argentina",                         "partial",  0.70,         "PLACEHOLDER — some measures adopted; verify",
  "DLL",    "Australia",                         "full",     0.90,         "PLACEHOLDER — ACAP signatory, AFMA requirements; verify",
  "DLL",    "Bulgaria",                          "none",     0.0,          "PLACEHOLDER — historical Soviet-era fleet; verify",
  "DLL",    "Chile",                             "partial",  0.60,         "PLACEHOLDER — some measures adopted; verify",
  "DLL",    "Falklands",                         "full",     0.90,         "PLACEHOLDER — 3/3 measures, good compliance; verify",
  "DLL",    "France",                            "full",     0.85,         "PLACEHOLDER — CCAMLR, EU, ACAP; verify",
  "DLL",    "Japan",                             "full",     0.85,         "PLACEHOLDER — CCAMLR member, ACAP; verify",
  "DLL",    "Namibia",                           "partial",  0.50,         "PLACEHOLDER — some measures; verify",
  "DLL",    "New Zealand",                       "full",     0.85,         "PLACEHOLDER — ACAP signatory, observer coverage required; verify",
  "DLL",    "Norway",                            "full",     0.85,         "PLACEHOLDER — ACAP signatory; verify",
  "DLL",    "Russia",                            "partial",  0.50,         "PLACEHOLDER — CCAMLR member, variable enforcement; verify",
  "DLL",    "South Africa",                      "full",     0.85,         "PLACEHOLDER — CCAMLR, 3/3 measures; verify",
  "DLL",    "South Korea",                       "partial",  0.60,         "PLACEHOLDER — CCAMLR member; verify",
  "DLL",    "Spain",                             "partial",  0.70,         "PLACEHOLDER — EU/ACAP; verify",
  "DLL",    "USA",                               "partial",  0.80,         "PLACEHOLDER — NMFS requirements; verify",
  "DLL",    "USSR",                              "none",     0.0,          "PLACEHOLDER — historical, pre-mitigation era",
  "DLL",    "Ukraine",                           "partial",  0.40,         "PLACEHOLDER — limited enforcement data; verify",
  "DLL",    "United Kingdom",                    "full",     0.90,         "PLACEHOLDER — South Georgia = UK territory, strong oversight; verify",
  "DLL",    "Uruguay",                           "partial",  0.40,         "PLACEHOLDER — some measures, limited data; verify",
  # --- PLL fleets ---
  "PLL",    "Australia",                         "partial",  0.75,         "PLACEHOLDER — ACAP, AFMA; verify",
  "PLL",    "Belize",                            "none",     0.0,          "flag of convenience",
  "PLL",    "Brazil",                            "partial",  0.40,         "PLACEHOLDER — some measures, lower compliance; verify",
  "PLL",    "China",                             "none",     0.0,          "PLACEHOLDER — limited adoption; verify",
  "PLL",    "Cook Islands",                      "none",     0.0,          "PLACEHOLDER — Pacific flag state, limited data; verify",
  "PLL",    "Cuba",                              "none",     0.0,          "no information",
  "PLL",    "Fiji",                              "none",     0.0,          "PLACEHOLDER — Pacific flag state; verify",
  "PLL",    "France Reunion",                    "partial",  0.60,         "PLACEHOLDER — EU requirements; verify",
  "PLL",    "French Polynesia",                  "partial",  0.60,         "PLACEHOLDER — EU/French requirements; verify",
  "PLL",    "Japan",                             "partial",  0.80,         "PLACEHOLDER — 2/3 in most RFMOs; verify",
  "PLL",    "Korea",                             "partial",  0.50,         "PLACEHOLDER — 2/3 in some areas; verify",
  "PLL",    "Namibia",                           "partial",  0.50,         "PLACEHOLDER — some measures; verify",
  "PLL",    "New Caledonia",                     "partial",  0.60,         "PLACEHOLDER — French territory, EU rules; verify",
  "PLL",    "New Zealand",                       "partial",  0.75,         "PLACEHOLDER — ACAP signatory; verify",
  "PLL",    "Niue",                              "none",     0.0,          "PLACEHOLDER — Pacific flag state; verify",
  "PLL",    "Other",                             "none",     0.0,          "mixed/unknown fleets",
  "PLL",    "Panama",                            "none",     0.0,          "flag of convenience",
  "PLL",    "Papua New Guinea",                  "none",     0.0,          "PLACEHOLDER — Pacific flag state; verify",
  "PLL",    "Portugal",                          "partial",  0.70,         "PLACEHOLDER — EU requirements, 2/3; verify",
  "PLL",    "Samoa",                             "none",     0.0,          "PLACEHOLDER — Pacific flag state; verify",
  "PLL",    "Seychelles",                        "none",     0.0,          "PLACEHOLDER — limited adoption; verify",
  "PLL",    "South Africa",                      "partial",  0.70,         "PLACEHOLDER — domestic requirements; verify",
  "PLL",    "Spain",                             "partial",  0.70,         "PLACEHOLDER — EU requirements, 2/3; verify",
  "PLL",    "St. Vincent and Grenadines",        "none",     0.0,          "flag of convenience",
  "PLL",    "Taiwan",                            "partial",  0.60,         "PLACEHOLDER — 2/3 adopted but variable compliance; verify",
  "PLL",    "Tonga",                             "none",     0.0,          "PLACEHOLDER — Pacific flag state; verify",
  "PLL",    "USA",                               "partial",  0.80,         "PLACEHOLDER — NMFS requirements; verify",
...
# Diagnostic: fleets in fleet_percap with no mitigation status — should be empty after table is complete
fleet_percap %>%
  distinct(fishery, fleet) %>%
  anti_join(fleet_mitigation, by = c("fishery", "fleet")) %>%
  print()
```
...
efficacy_scenarios <- list(
  ...
  "current"              = fleet_mitigation,                                  # kept for reference_pts calculation only
  # Uniform blanket scenarios — both fisheries treated the same
  "all_fleets_2of3"      = fleet_mitigation %>% mutate(base_efficacy = eff_2of3),
  "all_fleets_3of3"      = fleet_mitigation %>% mutate(base_efficacy = eff_3of3),
  # Fishery-isolated scenarios — one fishery mitigated, other zeroed out
  "pll_2of3_dll_zero"    = fleet_mitigation %>%
    mutate(base_efficacy = case_when(fishery == "PLL" ~ eff_2of3, TRUE ~ 0)),
  "dll_2of3_pll_zero"    = fleet_mitigation %>%
    mutate(base_efficacy = case_when(fishery == "DLL" ~ eff_2of3, TRUE ~ 0)),
  # Mixed scenarios — one fishery upgraded to 3/3, other keeps current lookup status
  "dll_current_pll_3of3" = fleet_mitigation %>%
    mutate(base_efficacy = case_when(fishery == "PLL" ~ eff_3of3, TRUE ~ base_efficacy)),
  "pll_current_dll_3of3" = fleet_mitigation %>%
    mutate(base_efficacy = case_when(fishery == "DLL" ~ eff_3of3, TRUE ~ base_efficacy))
)

# --- Define compliance levels ---
# "current" uses lookup table values; 50/75/100% span the policy adoption range
compliance_levels <- list(
  "compliance_current" = function(c) c,
...
scenario_plot <- scenario_results %>%
  filter(compliance_level != "compliance_current",
         efficacy_scenario != "current") %>%
  mutate(
   ...
   #   compliance_level == "compliance_current" ~ "Current",
...
p_scenarios <- ggplot(scenario_plot,
  ...
  geom_text(aes(label = round(lambda, 4)),
            ...
            hjust = -0.1, size = 2.5) +
  scale_fill_manual(values = c(#"Current" = "#d95f02",
                                "50%"     = "#6baed6",
                                "75%"     = "#2171b5",
                                "100%"    = "#084594"),
...
example_scen <- scenarios[["dll_current_pll_3of3__compliance_current"]]
...
key_scenarios <- c("no_mitigation__compliance_current",
                   "all_fleets_2of3__compliance_current",
                   "all_fleets_3of3__compliance_current",
                   "pll_2of3_dll_zero__compliance_current",
                   "dll_2of3_pll_zero__compliance_current",
                   "dll_current_pll_3of3__compliance_current",
                   "pll_current_dll_3of3__compliance_current")
...
scenario_heatmap_pts <- scenario_heatmap_pts %>%
  mutate(
    ...
    compliance_level = case_when(
      ...
      str_detect(scenario, "__compliance_current$") ~ "Current",
...
no_mit_lambda <- scenario_results %>%
  filter(scenario == "no_mitigation__compliance_current") %>% pull(lambda)
...
current_pt <- scenario_heatmap_pts %>% filter(scenario == "current__compliance_current")
...
# Nudged labels for overlapping scenarios — "current" efficacy shown as gold diamond reference, not label
heatmap_labels <- scenario_heatmap_pts %>%
  filter(compliance_level == "Current",
         !efficacy_scenario %in% c("Current", "No Mitigation", "Full Elimination")) %>%
  mutate(
    nudge_y = case_when(
      efficacy_scenario == "Dll Current Pll 3Of3" ~  0.02,
      efficacy_scenario == "Pll Current Dll 3Of3" ~ -0.02,
      efficacy_scenario == "All Fleets 2Of3"      ~ -0.02,
      TRUE ~ 0
    )
  )
...
p_heatmap <- ggplot(heatmap_data, aes(x = coverage, y = efficacy, fill = lambda)) +
  ...
  geom_label(data = reference_pts,
             ...
             label.padding = unit(0.15, "lines"),
             hjust = -0.1, vjust = 0.5) +
  scale_shape_manual(values = c("Current" = 18,
                                "50%"     = 0,
                                "75%"     = 17,
                                "100%"    = 16),
                     name = "Compliance level") +
...
p_heatmap_recovery_v2 <- ggplot(heatmap_data, aes(x = coverage, y = efficacy, fill = lambda >= 1)) +
  ...
  scale_fill_manual(values = c("TRUE" = "#2166ac", "FALSE" = "#b2182b"),
                    labels = c("TRUE" = "\u03BB \u2265 1 (recovery)", "FALSE" = "\u03BB < 1 (decline)"),
                    name = "") +
  scale_color_manual(values = scen_colors, name = "Mitigation scenario") +
  scale_shape_manual(values = c("Current" = 18,
                                "50%"     = 0,
                                "75%"     = 17,
                                "100%"    = 16),
...
zoom_labels <- zoom_pts %>%
  ...
  mutate(
    nudge_y = case_when(
      efficacy_scenario == "Dll Current Pll 3Of3" ~  0.015,
      efficacy_scenario == "Pll Current Dll 3Of3" ~ -0.015,
      TRUE ~ 0
    )
  )
...
# Qualitative palette for efficacy scenario points/lines
scen_colors <- setNames(
  RColorBrewer::brewer.pal(n = max(3, length(unique(scenario_heatmap_pts$efficacy_scenario))),
                           name = "Dark2")[seq_along(unique(scenario_heatmap_pts$efficacy_scenario))],
  sort(unique(scenario_heatmap_pts$efficacy_scenario))
)
...
labels_opt1 <- pts_opt1 %>%
  ...
  mutate(nudge_y = case_when(
    efficacy_scenario == "Dll Current Pll 3Of3" ~  0.03,
    efficacy_scenario == "Pll Current Dll 3Of3" ~ -0.03,
    TRUE ~ 0
  ))
...
ref_scenario <- "dll_current_pll_3of3__compliance_current"
...
fm_params_dll <- list(
  j1  = calc_fm_beta_params(dem_fm_j1),
...
fm_params_pll <- list(
  j1  = calc_fm_beta_params(pel_fm_j1),
